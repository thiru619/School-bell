...
import '../../crossword/controllers/crossword_controller.dart';

void showFindWordAddPopup(MenuPageController controller, BuildContext context) {
  final popup = Get.put(CrosswordPopupController());

  Get.dialog(
    AlertDialog(
      title: const Text("Add Crossword"),
      content: SizedBox(
        width: 380,
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              TextField(
                controller: popup.eachMark,
                keyboardType: TextInputType.number,
                decoration: const InputDecoration(
                  labelText: "Each Question Mark",
                ),
              ),
        ...
        ElevatedButton(
          onPressed: () {
            controller.addNewRecord({
              ...
              "total": int.tryParse(popup.totalMarks.text) ?? 1,
              "mark": int.tryParse(popup.eachMark.text) ?? 1,
